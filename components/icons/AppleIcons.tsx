...
export const AppleDocIcon: React.FC<IconProps> = ({ className = "h-4 w-4" }) => (
  ...
  >
    <g>
      {/* Document background */}
      <path
        d="M 15 5 h 45 l 15 15 v 60 c 0 2.761 -2.239 5 -5 5 H 15 c -2.761 0 -5 -2.239 -5 -5 V 10 c 0 -2.761 2.239 -5 5 -5 z"
        fill="#E8E8E8"
      />

      {/* Folded corner */}
      <path
        d="M 60 5 v 12 c 0 1.657 1.343 3 3 3 h 12 z"
        fill="#D0D0D3"
      />

      {/* Text lines */}
      <rect x="20" y="30" width="50" height="2" rx="1" fill="#B8B8BB"/>
      <rect x="20" y="38" width="45" height="2" rx="1" fill="#B8B8BB"/>
      <rect x="20" y="46" width="48" height="2" rx="1" fill="#B8B8BB"/>
      <rect x="20" y="54" width="42" height="2" rx="1" fill="#B8B8BB"/>
      <rect x="20" y="62" width="50" height="2" rx="1" fill="#B8B8BB"/>
      <rect x="20" y="70" width="38" height="2" rx="1" fill="#B8B8BB"/>
    </g>
  </svg>
);

// Small version for badges
export const AppleDocIconSmall: React.FC<IconProps> = ({ className = "h-2.5 w-2.5" }) => (
  <svg
    className={className}
    viewBox="0 0 90 90"
    xmlns="http://www.w3.org/2000/svg"
...
// Consistent Document Icon - Used throughout the app
