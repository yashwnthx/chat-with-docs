...
export const ChatHeader = memo(function ChatHeader({ onShowKnowledge, conversationName, onShowMobileSidebar, onShowSidebar, showSidebar, hasMessages, onRename, onDelete, onNewChat }: ChatHeaderProps) {
